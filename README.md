...
Worked on real-world data analysis tasks involving:
...
Built an interactive HR dashboard to analyze:
- Employee attrition
...
Created an Excel dashboard for housing market analysis including:
- Property prices
- Area comparisons
- Market trends
